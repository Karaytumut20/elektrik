  ...
  return (
    <section className="grid min-h-[70vh] place-items-center bg-electric-mist px-4 py-16 text-center">
      <div className="max-w-xl">
        ...
        <h1 className="mt-3 text-4xl font-bold text-slate-950">Sayfa bulunamadı</h1>
        <p className="mt-4 leading-7 text-slate-600">Aradığınız sayfa taşınmış veya kaldırılmış olabilir. Ana sayfaya dönebilir ya da hizmetleri inceleyebilirsiniz.</p>
