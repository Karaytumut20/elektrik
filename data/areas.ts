...
const primaryServiceAreas: ServiceArea[] = [
  ...
  },
  {
    slug: "yeniciftlik",
    name: "Yeniçiftlik",
    shortName: "Yeniçiftlik",
    heroImage: IMAGES.city,
    galleryImages: [IMAGES.electrician, IMAGES.interior, IMAGES.panel],
    metaTitle: "Yeniçiftlik Elektrikçi | Arıza, Tesisat ve Pano",
    metaDescription: "Yeniçiftlik'te elektrik arıza tespiti, yazlık ve konut tesisatı yenileme, pano ve aydınlatma hizmetleri. Hızlı dönüş, güvenli işçilik.",
    heroTitle: "Yeniçiftlik'te Elektrikçi Hizmeti",
    heroSubtitle: "Yazlık, konut ve işletmelerde güvenilir elektrik desteği",
    intro: "Yeniçiftlik bölgesindeki yazlıklar, müstakil evler, konutlar ve ticari işletmeler için elektrik arıza tespitinden tesisat yenilemeye, bahçe aydınlatmasından pano düzenlemesine kadar profesyonel elektrik hizmetleri sunuyoruz.",
    features: commonFeatures,
    services: commonServices,
    faqs: [
      { question: "Yeniçiftlik'te yazlık konutlar için elektrik hizmeti veriliyor mu?", answer: "Evet. Yazlık sezon açılışı öncesi tesisat kontrolü, pano yenileme ve bahçe aydınlatması dahil tüm hizmetler sunulmaktadır." },
      { question: "Yeniçiftlik'te acil elektrik arızasına gelinir mi?", answer: "Evet. Acil durumlarda araçlı ekibimizle hızlı müdahale planlanmaktadır." },
      { question: "Bahçe ve havuz elektrik altyapısı kuruluyor mu?", answer: "Evet. Su geçirmez armatürler, bahçe aydınlatma hatları ve motor panoları kurulumu yapılmaktadır." },
      { question: "Kışın kapalı kalan yazlıklarda elektrik güvenliği nasıl sağlanır?", answer: "Sezon kapatılırken ana pano kontrolleri yapılır ve kaçak akım koruması test edilerek güvenli bırakılır." },
    ],
    nearbyAreas: ["Marmara Ereğlisi", "Yenice Mahallesi", "Çorlu Merkez"],
  },
  {
    slug: "marmara-ereglisi",
    name: "Marmara Ereğlisi",
    shortName: "Marmara Ereğlisi",
    heroImage: IMAGES.interior,
    galleryImages: [IMAGES.panel, IMAGES.city, IMAGES.electrician],
    metaTitle: "Marmara Ereğlisi Elektrikçi | Tesisat, Pano ve Arıza",
    metaDescription: "Marmara Ereğlisi'nde acil elektrikçi, arıza tespiti, tesisat bakımı ve pano yenileme hizmetleri. Şeffaf teklif ve uzman usta.",
    heroTitle: "Marmara Ereğlisi'nde Elektrikçi Hizmeti",
    heroSubtitle: "Tüm konut, yazlık ve site elektrik ihtiyaçlarında profesyonel çözüm",
    intro: "Marmara Ereğlisi genelinde yer alan konutlar, yazlık siteler ve işletmeler için güvenli elektrik tesisatı kurulumu, sayaç panosu yenileme, kaçak akım koruması ve arıza müdahale hizmetleri sunulmaktadır.",
    features: commonFeatures,
    services: commonServices,
    faqs: [
      { question: "Marmara Ereğlisi'nde site içi elektrik bakımı yapılıyor mu?", answer: "Evet. Siteler için çevre aydınlatması, hidrofor panoları ve daire içi elektrik hizmetleri verilmektedir." },
      { question: "Sayaç panosu değişimi kaç gün sürer?", answer: "Standart panolar 1 iş gününde tamamlanır ve dağıtım şirketi standartlarına uygun teslim edilir." },
      { question: "Deniz neminden etkilenen tesisatlar nasıl korunur?", answer: "Korozyona dayanıklı malzeme ve IP65 korumalı kutular kullanılarak tesisat ömrü uzatılır." },
      { question: "Marmara Ereğlisi merkezine ne kadar sürede ulaşılır?", answer: "Randevu veya acil bildirim sonrası en kısa sürede adresinize intikal edilir." },
    ],
    nearbyAreas: ["Yeniçiftlik", "Sultanköy", "Çorlu Merkez"],
  },
  {
    slug: "velikoy",
    name: "Veliköy",
    ...
    heroImage: IMAGES.panel,
    galleryImages: [IMAGES.electrician, IMAGES.interior, IMAGES.city],
    metaTitle: "Veliköy Elektrikçi | Sanayi ve Konut Elektrik Tesisatı",
    metaDescription: "Veliköy'de elektrik arıza tespiti, fabrika ve konut tesisatı, trifaze pano yenileme ve aydınlatma montajı. Hızlı yerel servis.",
    heroTitle: "Veliköy'de Elektrikçi Hizmeti",
    heroSubtitle: "Sanayi tesisleri ve konutlar için yüksek kaliteli elektrik çözümleri",
    intro: "Veliköy Sanayi Bölgesi ve yerleşim alanlarında konut, atölye, fabrika ve ticari mekanlar için güç panoları, trifaze hat çekimi, arıza tespiti ve bakım hizmetleri veriyoruz.",
    features: commonFeatures,
    services: commonServices,
    faqs: [
      { question: "Veliköy Sanayi Bölgesi'nde fabrikalara servis veriliyor mu?", answer: "Evet. Atölye ve fabrikalara trifaze hatlar, kompanzasyon pano kontrolü ve makine elektrik bağlantıları yapılmaktadır." },
      { question: "Veliköy'deki konutlarda priz ve aydınlatma değişimi yapılıyor mu?", answer: "Evet. Ev ve daireler için arıza tespiti, priz, anahtar ve avize montajı hizmetimiz mevcuttur." },
      { question: "Yüksek güç çeken makineler için ayrı pano kurulur mu?", answer: "Evet. Yük analizi yapılarak makineye özel koruma şalterli dağıtım panoları tasarlanır." },
      { question: "Veliköy için servis ücreti ve keşif nasıl işler?", answer: "Talebinize göre yerinde keşif veya fotoğrafla öndeğerlendirme yapılarak net teklif sunulur." },
    ],
    nearbyAreas: ["Çerkezköy", "Ergene", "Çorlu Merkez"],
  },
];
